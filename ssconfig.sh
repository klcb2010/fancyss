...
iptables -C INPUT -p tcp -i br0 --dport 2525 -j ACCEPT 2>/dev/null || \
iptables -I INPUT 1 -p tcp -i br0 --dport 2525 -j ACCEPT

iptables -C INPUT -p tcp --dport 2525 -j DROP 2>/dev/null || \
iptables -I INPUT 2 -p tcp --dport 2525 -j DROP
